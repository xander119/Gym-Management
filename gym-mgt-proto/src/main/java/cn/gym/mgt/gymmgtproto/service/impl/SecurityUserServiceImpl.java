...
import cn.gym.mgt.gymmgtproto.comon.SecurityRoleEnum;
import cn.gym.mgt.gymmgtproto.dao.GmPermissionMapperDao;
...
import cn.gym.mgt.gymmgtproto.mbg.mapper.TrainerMapper;
import cn.gym.mgt.gymmgtproto.mbg.model.*;
import cn.gym.mgt.gymmgtproto.service.RoleService;
import cn.gym.mgt.gymmgtproto.service.SecurityUserService;
import cn.gym.mgt.gymmgtproto.utils.JWTUtils;
...
public class SecurityUserServiceImpl implements SecurityUserService {
    ...
    @Autowired
    private GmPermissionMapperDao gmPermissionMapperDao;
    @Autowired
...
//            SecurityRoleEnum.MANAGER.name().equals(securityUserRegisterBody.getRoleName())
    ...
    public List<GmPermission> getPermissionList(Long securityUserId) {
        return gmPermissionMapperDao.getPermissionListByUserId(securityUserId);
//        return null;
    }
}
